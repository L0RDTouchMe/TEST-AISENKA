...
"background-color: rgb(95, 94, 123);")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(90, 40, 481, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(60, 100, 511, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(90, 250, 481, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(70, 190, 481, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.NO4.setGeometry(QtCore.QRect(250, 290, 82, 17))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.YES4.setGeometry(QtCore.QRect(200, 290, 41, 17))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_9.setGeometry(QtCore.QRect(150, 370, 221, 41))
        font = QtGui.QFont()
        font.setPointSize(13)
...
"background-color: rgb(73, 89, 123);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Часть 2"))
        self.label.setText(_translate("MainWindow", "Бывает ли у вас иногда дурное настроение?"))
        self.label_2.setText(_translate("MainWindow", "Когда вас втягивают в ссору, предпочитаете ли вы"))
        self.label_3.setText(_translate("MainWindow", "Нравится ли вам находиться среди людей?"))
        self.label_4.setText(_translate("MainWindow", "Легко ли вы поддаетесь переменам настроения?"))
        self.label_5.setText(_translate("MainWindow", "Часто ли вы теряли сон из-за своих тревог?"))
        self.label_7.setText(_translate("MainWindow", " отмолчаться, надеясь, что все обойдется?"))
        ...
        self.label_9.setText(_translate("MainWindow", "Упрямитесь ли вы иногда?"))
